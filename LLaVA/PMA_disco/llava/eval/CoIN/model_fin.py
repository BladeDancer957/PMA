...
def eval_model(args):
    ...
    tokenizer, model, image_processor, context_len = load_pretrained_model(args.expert_init_num, model_path, args.model_base, model_name, num_task=args.num_task, text_tower=args.text_tower)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--expert-init-num", type=int, default=1)
