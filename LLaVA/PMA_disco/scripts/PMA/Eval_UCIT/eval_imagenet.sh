...
expert_init_num=$(read_config "$TRAIN_CONFIG" expert_init_num)
...
# CUDA_VISIBLE_DEVICES=0 python /home/xxxxxxx/code/PMA/LLaVA/PMA_disco/llava/eval/CoIN/model_others.py \
...
#     --num-task $NUM_TASK \
#     --answers-file $RESULT_DIR/$STAGE/debug.jsonl \
#     --num-chunks 1 \
#     --chunk-idx 0 \
#     --temperature 0 \
#     --expert-init-num $expert_init_num \
#     --conv-mode vicuna_v1
